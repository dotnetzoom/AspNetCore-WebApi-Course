...
namespace WebFramework.Configuration
{
    public static class ApplicationBuilderExtensions
    {
        ...
        public static IApplicationBuilder IntializeDatabase(this IApplicationBuilder app)
        {
            ...
            ApplicationDbContext dbContext = scope.ServiceProvider.GetService<ApplicationDbContext>(); //Service locator
            ...
            System.Collections.Generic.IEnumerable<IDataInitializer> dataInitializers = scope.ServiceProvider.GetServices<IDataInitializer>();
            foreach (IDataInitializer dataInitializer in dataInitializers)
            {
